...
Панели и ММ-ка ведут обмен по **BACNet**-у. Ветки сети (см. схему сети C-WEB и SafedLink) с панелями то одна, то другая попеременно отваливаются. Валятся десятки ошибок и предупреждений. В связи с этим надо внести следующие изменения:
 ...
 - обновить ММ-ку **4.40** -> **4.70** (сущ. сервисный USB-вый ключ заменить на объектовый),
...
#### Адреса 2-х сетевых плат на ММ-ке (одна - панели, вторая - в Интернет через локальную подсеть)
