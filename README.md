...
Панели и ММ-ка ведут обмен по BACNet-у - то одна, то другая ветка с панелями отваливается, надо:
 - обновить ММ-ку 4.40 -> 4.70,
 - перевести с BACNet-а на OPC-сервер,
 - переключить панели и ММ-ку с SafedLink-а на локальную сеть (все панели стоят в кроссовых рядом с коммутаторами локальной подсети).
